...
permalink: /notes/
---
<div id="notes-entry-container" class="content-with-side-panel">
  <content class="content-with-side-panel__content">
    <h1>Notes</h1>
  ...
  <side class="side-panel content-with-side-panel__side" aria-label="Marginalia">
