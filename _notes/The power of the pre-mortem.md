---
title: The power of the pre-mortem
publish_date: 2022-08-16
published: true
---
I was introduced to the concept of the premortem by [Haley Bryant](https://www.haleymbryant.com/), my COO at Animalz.
...
> **_This customer churned 3-months into our relationship. Why?_**
...
Haley introduced me to the premortem by way of Gary Klein’s research paper, [The Misuse of Premortems on Wall Street](https://capitalallocatorspodcast.com/wp-content/uploads/Klein-Sonkin-and-Johnson-2019-The-Misuse-of-Premortems-on-Wall-Street.pdf). The paper’s key point: a premortem isn't a box-checking exercise to validate your latest brainwave. It's an active process designed to increase a project's likelihood of success.
...
- [Negative visualisation](https://en.wikipedia.org/wiki/Pessimism#Ancient_Greeks): we identify, internalize and become comfortable with the full range of possible outcomes. We admit that failure is not only possible, but likely, and we allow ourselves to prepare for the worst-case scenario.
    

In many ways, the premortem is pure Stoic philosophy in action:

> _"Remember that all we have is 'on loan' from Fortune, which can reclaim it without our permission—indeed, without even advance notice.  
>   
> Thus, we should love all our dear ones, but always with the thought that we have no promise that we may keep them forever—nay, no promise even that we may keep them for long.”_
> 
> _—Seneca_
